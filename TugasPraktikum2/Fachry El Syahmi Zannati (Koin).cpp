...
void koin(int kembalian) {
    int u100, u75, u50, u20, u10, u5, u2, u1, k1000, k500, k200, k100;
    
    //koin
    u100=kembalian/100000;
    kembalian%=100000;
    ...
    if (u100 > 0)cout<<u100<<" uang kertas Rp. 100.000,00" <<endl;
    if (u75 > 0)cout<<u75<<" uang kertas Rp. 75.000,00" <<endl;
    if (u50 > 0)cout<<u50<<" uang kertas Rp. 50.000,00" <<endl;
    if (u20 > 0)cout<<u20<<" uang kertas Rp. 20.000,00" <<endl;
    if (u10 > 0)cout<<u10<<" uang kertas Rp. 10.000,00" <<endl;
    if (u5 > 0)cout<<u5<<" uang kertas Rp. 5.000,00" <<endl;
    if (u2 > 0)cout<<u2<<" uang kertas Rp. 2.000,00" <<endl;
    if (k1000 > 0)cout<<k1000<<" koin 1000" <<endl;
    if (k500 > 0)cout<<k500<<" koin Rp. 500,00"<<endl;
    if (k200 > 0)cout<<k200<<" koin Rp. 200,00"<< endl;
    if (k100 > 0)cout<<k100<<" koin Rp. 100,00"<<endl;
}

int main() {
	// part deklarasi / declare
	long long b1, b2, b3, b4, b5, jum, total, bayar, kembalian, puser;
	string nama;
